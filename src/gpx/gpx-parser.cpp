...
namespace GPS::GPX
{
  ...
  GPS::TimeStampedWaypoint extractTrackPointFromTrkpt(const XML::Element& trkpt)
  {
  ...
  std::vector<GPS::TimeStampedWaypoint> extractTrackPointsFrom(const XML::Element& element)
  {
      std::vector<GPS::TimeStampedWaypoint> trackPoints;
  ...
  std::vector<GPS::TimeStampedWaypoint> extractTrackPointsFromTrk(const XML::Element& trk)
  {
      if (trk.containsSubElement("trkseg"))
      {
          ...
          for (unsigned int i = 0; i < trk.countSubElements("trkseg"); ++i)
          {
              ...
              std::vector<GPS::TimeStampedWaypoint> trackPointsInThisSegment = extractTrackPointsFrom(trkseg);
  ...
  std::vector<GPS::TimeStampedWaypoint> parseTrackStream(std::istream& gpxStream)
  {
  ...
  std::vector<GPS::TimeStampedWaypoint> parseTrackString(const std::string& gpxText)
  {
